...
**The Warning:** For a `HashSet` to work, the objects you put into it **must** correctly override `hashCode()` and `equals()`. If two "equal" objects have different hash codes, you’ll end up with duplicates in your "unique" set—a classic production bug.
