In our last session, we talked about writing raw text and characters to files. But in a complex application, you aren't just writing "Hello World"—you are working with objects like `User`, `Order`, or `GameLevel`.
...
I can tell you that ignoring this is the #1 cause of serialization bugs. This is a version number for your class.
